...
interface AkademikDestekSayfasiProps {
  onGeriDon: () => void;
  kullaniciAdi: string;
  kullaniciRol: string;
  tumBasliklar: any[];
...
export function AkademikDestekSayfasi({
  onGeriDon,
  kullaniciAdi,
  kullaniciRol,
  tumBasliklar,
  ...
  // Akademik Destek kategorisine ait başlıkları filtrele
  const akademikBasliklar = tumBasliklar.filter((b) => b.kategori === "akademik");

  // Sıralama
  const siraliBasliklar = [...akademikBasliklar].sort((a, b) => {
  ...
  // Sol ve sağ kolon için başlıkları böl
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#fcedd3]/10 to-white dark:from-neutral-950 dark:via-[#102a6b]/20 dark:to-neutral-950">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-600 dark:text-neutral-400">{akademikBasliklar.length} içerik</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-2xl">Akademik Destek Merkezi</h2>
            </div>
            <p className="text-white/90 text-sm leading-relaxed">
              Ders notları, sınav hazırlık ipuçları, ödev yardımı ve akademik başarı için gerekli tüm kaynakları burada bulabilirsiniz. 
              Deneyimli öğrenciler ve uzmanlardan ders çalışma teknikleri, kariyer tavsiyeleri ve akademik rehberlik alın. 
              Birlikte öğrenerek başarıya ulaşalım!
            </p>
          </div>
        </motion.div>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className="shrink-0 px-3 py-1 rounded-full bg-gradient-to-r from-[#1d2633]/10 to-[#28374a]/10 text-xs text-[#1d2633] dark:text-[#7B99B3]">
                    {baslik.kategori === "akademik" ? "Akademik" : baslik.kategori}
                  </span>
                </div>
        ...
        {/* Boş Durum */}
        {akademikBasliklar.length === 0 && (
          <div className="text-center py-12">
            <Award className="w-16 h-16 mx-auto text-neutral-300 dark:text-neutral-600 mb-4" />
            <p className="text-neutral-600 dark:text-neutral-400">Henüz akademik içerik bulunmamaktadır.</p>
          </div>
        )}
      </div>
