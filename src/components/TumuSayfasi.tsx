...
export function TumuSayfasi({
  ...
  const siraliBasliklar = [...tumBasliklar].sort((a, b) => {
  ...
  const getKategoriIsmi = (kategori: string) => {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-600 dark:text-neutral-400">{tumBasliklar.length} içerik</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-2xl">Tüm İçerikler</h2>
            </div>
            <p className="text-white/90 text-sm leading-relaxed">
              Platformdaki tüm kategorilerden içerikleri burada görebilirsiniz. 
              Akademik destek, sosyal yaşam, keşif rehberi, kariyer, etkinlikler ve daha fazlası! 
              Konya'daki üniversite yaşamınızı daha iyi hale getirecek her türlü bilgi ve deneyim paylaşımı bir arada.
            </p>
          </div>
        </motion.div>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className="shrink-0 px-3 py-1 rounded-full bg-gradient-to-r from-[#1d2633]/10 to-[#28374a]/10 text-xs text-[#1d2633] dark:text-[#7B99B3]">
                    {getKategoriIsmi(baslik.kategori)}
                  </span>
                </div>
        ...
        {tumBasliklar.length === 0 && (
          <div className="text-center py-12">
            <Home className="w-16 h-16 mx-auto text-neutral-300 dark:text-neutral-600 mb-4" />
            <p className="text-neutral-600 dark:text-neutral-400">Henüz içerik bulunmamaktadır.</p>
          </div>
        )}
      </div>
