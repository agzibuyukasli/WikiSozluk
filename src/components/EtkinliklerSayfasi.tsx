...
interface EtkinliklerSayfasiProps {
  onGeriDon: () => void;
  kullaniciAdi: string;
  kullaniciRol: string;
  tumBasliklar: any[];
...
export function EtkinliklerSayfasi({
  onGeriDon,
  kullaniciAdi,
  kullaniciRol,
  tumBasliklar,
  ...
  const etkinlikBasliklar = tumBasliklar.filter((b) => b.kategori === "etkinlik");

  const siraliBasliklar = [...etkinlikBasliklar].sort((a, b) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#fcedd3]/10 to-white dark:from-neutral-950 dark:via-[#102a6b]/20 dark:to-neutral-950">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-600 dark:text-neutral-400">{etkinlikBasliklar.length} içerik</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-2xl">Etkinlikler Merkezi</h2>
            </div>
            <p className="text-white/90 text-sm leading-relaxed">
              Kampüste ve Konya'da düzenlenen tüm etkinlikler, konserler, workshoplar, seminerler ve sosyal sorumluluk projeleri burada! 
              Öğrenci kulüplerinin organizasyonları, akademik konferanslar ve eğlence aktiviteleri hakkında bilgi alın. 
              Etkinliklere katılarak yeni insanlarla tanışın ve kampüs deneyiminizi zenginleştirin.
            </p>
          </div>
        </motion.div>
        ...
        {etkinlikBasliklar.length === 0 && (
          <div className="text-center py-12">
            <Calendar className="w-16 h-16 mx-auto text-neutral-300 dark:text-neutral-600 mb-4" />
            <p className="text-neutral-600 dark:text-neutral-400">Henüz etkinlik içeriği bulunmamaktadır.</p>
          </div>
        )}
      </div>
