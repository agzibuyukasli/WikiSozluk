...
export function DigerSayfasi({
  ...
  const digerBasliklar = tumBasliklar.filter((b) => b.kategori === "diger");

  const siraliBasliklar = [...digerBasliklar].sort((a, b) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#fcedd3]/10 to-white dark:from-neutral-950 dark:via-[#102a6b]/20 dark:to-neutral-950">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-600 dark:text-neutral-400">{digerBasliklar.length} içerik</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-2xl">Diğer Konular</h2>
            </div>
            <p className="text-white/90 text-sm leading-relaxed">
              Diğer kategorilere sığmayan ilginç konular, genel tartışmalar, öneriler ve paylaşımlar için özel alan! 
              Farklı fikirler, yaratıcı projeler, eğlenceli anketler ve topluluk için yararlı her türlü bilgi burada. 
              Özgürce fikir paylaşın ve topluluğun zenginliğine katkıda bulunun.
            </p>
          </div>
        </motion.div>
        ...
        {digerBasliklar.length === 0 && (
          <div className="text-center py-12">
            <Sparkles className="w-16 h-16 mx-auto text-neutral-300 dark:text-neutral-600 mb-4" />
            <p className="text-neutral-600 dark:text-neutral-400">Henüz diğer kategoride içerik bulunmamaktadır.</p>
          </div>
        )}
      </div>
