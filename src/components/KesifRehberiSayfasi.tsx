...
interface KesifRehberiSayfasiProps {
  onGeriDon: () => void;
  kullaniciAdi: string;
  kullaniciRol: string;
  tumBasliklar: any[];
...
export function KesifRehberiSayfasi({
  onGeriDon,
  kullaniciAdi,
  kullaniciRol,
  tumBasliklar,
  ...
  const kesifBasliklar = tumBasliklar.filter((b) => b.kategori === "kesif");

  const siraliBasliklar = [...kesifBasliklar].sort((a, b) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#fcedd3]/10 to-white dark:from-neutral-950 dark:via-[#102a6b]/20 dark:to-neutral-950">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-600 dark:text-neutral-400">{kesifBasliklar.length} içerik</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-2xl">Keşif Rehberi</h2>
            </div>
            <p className="text-white/90 text-sm leading-relaxed">
              Konya'nın gizli kalmış köşelerini, en güzel kafeleri, restoranları ve gezilecek yerlerini keşfedin! 
              Öğrenci dostu mekanlar, bütçeye uygun seçenekler ve şehirdeki en popüler noktalar hakkında detaylı bilgiler. 
              Yerel rehberler ve öğrencilerin deneyimlerinden faydalanarak Konya'yı en iyi şekilde keşfedin.
            </p>
          </div>
        </motion.div>
        ...
        {kesifBasliklar.length === 0 && (
          <div className="text-center py-12">
            <MapPin className="w-16 h-16 mx-auto text-neutral-300 dark:text-neutral-600 mb-4" />
            <p className="text-neutral-600 dark:text-neutral-400">Henüz keşif rehberi içeriği bulunmamaktadır.</p>
          </div>
        )}
      </div>
